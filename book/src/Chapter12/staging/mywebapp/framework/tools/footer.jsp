...
<%String portalName = (String)getSessionValue(PortalTagConstants.PORTAL_NAME, request);%>
<%
...
<table align="left" width="802">
  ...
  <tr>
	<td width="1%"><a href="http://www.bea.com"><img src="<wf:createResourceURL resource="<%=resourceURL%>"/>" width="801" height="50" border="0"></A>
  </td>
  </tr>
</table>